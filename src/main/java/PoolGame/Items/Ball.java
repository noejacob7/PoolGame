...
public class Ball implements Drawable, Movable, Observer {
    ...
    public Ball(String colour, double xPos, double yPos, double xVel, double yVel, double mass, BallType type, BallPocketStrategy pocketAction) throws IllegalArgumentException {
        ...
        this.mousePointer = new Circle();
        this.mousePointer.setVisible(false);
    ...
    public void addToGroup(ObservableList<Node> groupChildren) {
        ...
        groupChildren.add(this.mousePointer);
    }
    ...
    private void registerCueBallMouseAction() {
        this.shape.setOnMouseClicked(
                ...
                if (this.hasStopped()) {
                    ...
                    this.mouseDragLine.setEndX(this.shape.getCenterX());
                    this.mouseDragLine.setEndY(this.shape.getCenterY());
                    this.mousePointer.setCenterX(this.shape.getCenterX());
                    this.mousePointer.setCenterY(this.shape.getCenterY());
                    this.mousePointer.setRadius(this.shape.getRadius()*0.75);
                    this.mousePointer.setVisible(true);
                    this.mousePointer.setFill(Paint.valueOf("MAROON"));
                    this.mouseDragLine.setStrokeWidth(5);
                    this.mouseDragLine.setStroke(Paint.valueOf("SIENNA"));
                }
        });
        this.mousePointer.setOnMouseDragged(
                (actionEvent) -> {
                    this.mouseDragLine.setVisible(true);
                    this.mouseDragLine.setStartX(this.shape.getCenterX());
                    this.mouseDragLine.setStartY(this.shape.getCenterY());
                    ...
                    this.mousePointer.setCenterY(actionEvent.getSceneY());
                    this.mousePointer.setCenterX(actionEvent.getSceneX());
                }
        );
        this.mousePointer.setOnMouseReleased(
                (actionEvent) -> {
...
//        );
    ...
    */
    ...
    public void incrementScore(){
        this.scoreBoard.incrementScore(this.scoreIncrement);
    }
